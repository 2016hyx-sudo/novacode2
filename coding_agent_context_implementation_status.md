...
- M4 InteractionGroup management; deterministic Trajectory Fold at 70% with state delta merge; WAL tool_batch_intent / tool_batch_closed events; complete trajectory archive (`trajectory-archive.jsonl`).
